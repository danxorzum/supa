...
extension SupaConstraints on BoxConstraints {
  bool get isW => ScreenSize.w.offset.isInRange(minWidth);
  ...
  bool get biggerThanW => maxWidth > ScreenSize.w.offset.dx;
  ...
  bool get smallerThanW => maxWidth < ScreenSize.w.offset.dx;
